...
Hard-locked equations & Core definitions are frozen in \eqref{eq:exec_update}--\eqref{eq:reward}. \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{paper/submission_figures/fig_aux_frontiers_submission.pdf}
