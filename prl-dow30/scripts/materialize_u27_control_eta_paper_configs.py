...
def main() -> None:
    ...
    final_config_path = _resolve(args.final_config_out)
    ...
    payload = {
        ...
        "final_config_out": str(final_config_path.relative_to(ROOT)),
        "forward_config_out": str(forward_config_path.relative_to(ROOT)),
        ...
        "final_output_root": args.final_output_root or final_cfg.get("output", {}).get("root"),
        "forward_output_root": args.forward_output_root or forward_cfg.get("output", {}).get("root"),
    }
