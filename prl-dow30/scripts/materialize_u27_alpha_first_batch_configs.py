...
CANDIDATES: list[dict[str, Any]] = [
    {
        "tag": "u27_eta082_alpha_ctrl_20k_r1",
    ...
    {
        "tag": "u27_eta082_alpha_cs61_20k_r1",
    ...
    {
        "tag": "u27_eta082_alpha_vsmom_20k_r1",
    ...
    {
        "tag": "u27_eta082_alpha_resid_20k_r1",
...
def main() -> None:
    ...
    for candidate in CANDIDATES:
        ...
        cfg["output"]["root"] = f"outputs/{candidate['tag']}"
        ...
        config_rel = f"configs/exp/{candidate['tag']}.yaml"
    ...
    meta = {
        ...
        "generated": generated,
        "rationale_csv_out": args.rationale_csv_out,
        "rationale_md_out": args.rationale_md_out,
    }
