...
- Keep this comparator auxiliary.
- Do not present it as the main identification result.
- Preserve the same-state setup.
- Preserve the fixed ridge forecast-map setup.
- Preserve the kappa=0 collapse logic.
- Do not silently refit the forecast map unless the spec explicitly requires it.
...
- selected c remains 3000 or matches the reproduced expected setup
- wording stays auxiliary/supporting only
- result is written as same-direction supporting evidence, not core evidence
