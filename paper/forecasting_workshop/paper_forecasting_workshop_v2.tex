...
\item Second, we document a Q2 failure mode in which the forecast-side winner becomes recurrently deployed-suboptimal as friction increases under the studied fixed interfaces.
\item Third, we provide a Q2-first evidence hierarchy with a synthetic zero-friction anchor, forecasting-native event and traffic evidence, and operational corroboration, while using Q1 only to explain why the divergence can arise.
\end{itemize}
