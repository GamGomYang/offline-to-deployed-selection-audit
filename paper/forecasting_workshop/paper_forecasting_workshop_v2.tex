...
\caption{Fixed-interface evaluation maps forecasts through a shared interface before deployed scoring. Zero/low friction is mixed, while moderate-to-high friction shows recurrent mismatch between forecast-side and deployed-side winners.}
...
Q2 asks the paper's headline benchmark question: under one fixed forecast-to-decision interface, does the forecast-side winner remain the deployed-side winner? Synthetic provides the exact zero-friction sanity anchor; Figure~\ref{fig:fixed-interface-inversion} combines the fixed-interface mechanism with winner-inversion evidence in the forecasting-native and corroborative domains.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\columnwidth]{assets/figures/fig_q2_event_micro_support.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\columnwidth]{assets/figures/fig_event_micro_interface_uncertainty_appendix.png}
