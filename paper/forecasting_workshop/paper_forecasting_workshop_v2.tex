...
\begin{figure}[H]
\centering
\makebox[\columnwidth][c]{\includegraphics[width=1.32\columnwidth]{assets/figures/fig_q2_winner_inversion_heatmap_v2.pdf}}
...
\caption{Event-micro Q2 evidence. Under a fixed thresholding interface, the forecast-side winner remains Reactive sharp, but the deployed winner shifts as switching friction increases. The forecast-selected model becomes recurrently deployed-suboptimal at moderate and high friction.}
